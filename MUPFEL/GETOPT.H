/*
	@(#)Mupfel/getopt.h
	@(#)Julian F. Reschke & Stefan Eissing, 29. April 1991
...
int getopt_long (MGLOBAL *M, GETOPTINFO *G, int argc, char **argv, 
		const char *shortopts, const struct option *longopts, 
		int *longind);

int getopt_long_only (MGLOBAL *M, GETOPTINFO *G, int argc, 
		char **argv, const char *shortopts,
		const struct option *longopts, int *longind);

void envopt (GETOPTINFO *G, int *pargc, char ***pargv, char *optstr);
